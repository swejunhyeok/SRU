...
def main():
    ...
    test_dataset = non_processing_custom_dataset("./Dataset/", args.file_list)
...
def test(test_loader, hr_model, br_model, criterion):
    ...
    total_csv_logger = CSVLogger(args=args, fieldnames=['video_name', 'HR_label', 'HR_predict', 'HR_MAE/BPM', 'BR_label', 'BR_predict', 'BR_MAE/BPM'], filename=file_name+'.csv')
